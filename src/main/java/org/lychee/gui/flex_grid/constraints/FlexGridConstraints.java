package org.lychee.gui.flex_grid.constraints;
...
import static org.lychee.gui.flex_grid.Arguments.requirePositive;
import static org.lychee.gui.flex_grid.Utils.requireNonNull;
...
public abstract sealed class FlexGridConstraints<C extends FlexGridConstraints<C>> {
	 ...
	 */
	public static final class Relative extends FlexGridConstraints<Relative> {
	 ...
	 */
	public static final class Absolute extends FlexGridConstraints<Absolute> {
